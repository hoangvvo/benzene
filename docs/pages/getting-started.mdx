...
Before we make a mutation, let's try to subscribe to our posts' changes using GraphQL Subscription.
...
You will also notice a message coming from the WebSocket channel:
