...
After creating a [Benzene instance](http://localhost:3000/reference/benzene), we create HTTP and WebSocket handler by supplying the it to the `makeHandler` functions from
