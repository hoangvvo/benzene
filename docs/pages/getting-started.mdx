...
take a look at the [runtime](/reference/runtime) documentation. Below is an example using `graphql-jit` (from the `@benzene/jit` package) more than 2x performance improvement.
