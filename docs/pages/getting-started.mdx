...
This tutorial will take you through the process of building a GraphQL server with `@benzene/server` and `@benzene/ws`. We will build a simple book voting app that can:
...
Check out the [CodeSandbox demo](https://codesandbox.io/s/github/hoangvvo/benzene/tree/main/examples/book-votes)

### Trying out with DevTools

Without building a front-end, you can still test out the Getting Started example using DevTools.
