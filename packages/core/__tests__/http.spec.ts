...
describe('GET functionality', () => {
  test('allows GET with query param', () => {
    return httpTest(
  ...
  test('allows GET with variable values', () => {
    return httpTest(
      {
        method: 'GET',
        queryParams: {
  ...
  test('allows GET with operation name', () => {
    return httpTest(
      {
        method: 'GET',
        queryParams: {
  ...
  test('Errors when sending a mutation via GET', () => {
    return httpTest(
      {
        method: 'GET',
        queryParams: {
  ...
  test('Errors when selecting a mutation within a GET', () => {
    return httpTest(
      {
        method: 'GET',
        queryParams: {
  ...
  test('Allows a mutation to exist within a GET', () => {
    return httpTest(
      {
        method: 'GET',
        queryParams: {
  ...
  test('Allows passing in a context', async () => {
...
describe('POST functionality', () => {
  ...
  test('alows POST with JSON encoding with additional directives', () => {
    return httpTest(
      {
        method: 'POST',
        body: { query: '{test}' },
  ...
  test('Allows POST with url encoding', async () => {
    return httpTest(
      {
        method: 'POST',
  ...
  test('supports POST JSON query with GET variable values', () => {
    return httpTest(
      {
        method: 'POST',
        queryParams: {
  ...
  test('supports POST url encoded query with GET variable values', () => {
    return httpTest(
      {
        method: 'POST',
        queryParams: {
  ...
  test('supports POST raw text query with GET variable values', () => {
    return httpTest(
      {
        method: 'POST',
        queryParams: {
  ...
  test('allows POST with GET operation name', async () => {
    return httpTest(
      {
        method: 'POST',
        queryParams: {
...
describe('Error handling functionality', () => {
  ...
  test('allows for custom error formatting to sanitize', () => {
    return httpTest(
      {
        method: 'GET',
        queryParams: {
  ...
  test('handles incomplete JSON bodies', async () => {
    return httpTest(
      {
        method: 'POST',
        body: '{"query":',
  ...
  test('handles plain POST text', async () => {
    return httpTest(
      {
        method: 'POST',
        queryParams: {
